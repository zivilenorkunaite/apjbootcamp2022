...
-- This is also not a streaming table - it uses static json file as input
CREATE TEMPORARY LIVE TABLE lookup_users
...
FROM 
json.`/tmp/databricksbootcamp/datasets/users/users.json`;
